	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T, dir string, mock *markdown.Mock) {
				...
				mock.On("LoadMetadata", "memos", "00000000-slug-1").Return(map[string]interface{}{}, nil).Once()
				mock.On("LoadMetadata", "memos", "00000000-slug-2").Return(map[string]interface{}{}, nil).Once()
				mock.On("LoadMetadata", "memos", "00000000-slug-3").Return(map[string]interface{}{}, nil).Once()
			},
			teardown: func(t *testing.T, dir string) {
